...
milano_csuolo=raster("data/milano_ispra_csuolo_clip.tif")
...
palermo_csuolo=raster("data/palermo_ispra_csuolo_clip.tif")
...
bologna_csuolo=raster("data/bologna_ispra_csuolo_clip.tif")
...
roma_csuolo=raster("data/Roma_ispra_csuolo_clip.tif")
...
firenze_csuolo=raster("data/firenze_ispra_csuolo_clip.tif")
...
firenze_LST_DJF_mean=readRDS("data/firenze_LST_DJF_mean.rds")
firenze_LST_SON_mean=readRDS("data/firenze_LST_SON_mean.rds")
firenze_LST_MAM_mean=readRDS("data/firenze_LST_MAM_mean.rds")
firenze_LST_JLA_mean=readRDS("data/firenze_LST_JLA_mean.rds")
firenze_LST_DJF_sd=readRDS("data/firenze_LST_DJF_sd.rds")
firenze_LST_SON_sd=readRDS("data/firenze_LST_SON_sd.rds")
firenze_LST_MAM_sd=readRDS("data/firenze_LST_MAM_sd.rds")
firenze_LST_JLA_sd=readRDS("data/firenze_LST_JLA_sd.rds")
...
milano_LST_DJF_mean=readRDS("data/milano_LST_DJF_mean.rds")
milano_LST_SON_mean=readRDS("data/milano_LST_SON_mean.rds")
milano_LST_MAM_mean=readRDS("data/milano_LST_MAM_mean.rds")
milano_LST_JLA_mean=readRDS("data/milano_LST_JLA_mean.rds")
milano_LST_DJF_sd=readRDS("data/milano_LST_DJF_sd.rds")
milano_LST_SON_sd=readRDS("data/milano_LST_SON_sd.rds")
milano_LST_MAM_sd=readRDS("data/milano_LST_MAM_sd.rds")
milano_LST_JLA_sd=readRDS("data/milano_LST_JLA_sd.rds")
...
roma_LST_DJF_mean=readRDS("data/roma_LST_DJF_mean.rds")
roma_LST_SON_mean=readRDS("data/roma_LST_SON_mean.rds")
roma_LST_MAM_mean=readRDS("data/roma_LST_MAM_mean.rds")
roma_LST_JLA_mean=readRDS("data/roma_LST_JLA_mean.rds")
roma_LST_DJF_sd=readRDS("data/roma_LST_DJF_sd.rds")
roma_LST_SON_sd=readRDS("data/roma_LST_SON_sd.rds")
roma_LST_MAM_sd=readRDS("data/roma_LST_MAM_sd.rds")
roma_LST_JLA_sd=readRDS("data/roma_LST_JLA_sd.rds")
...
bologna_LST_DJF_mean=readRDS("data/bologna_LST_DJF_mean.rds")
bologna_LST_SON_mean=readRDS("data/bologna_LST_SON_mean.rds")
bologna_LST_MAM_mean=readRDS("data/bologna_LST_MAM_mean.rds")
bologna_LST_JLA_mean=readRDS("data/bologna_LST_JLA_mean.rds")
bologna_LST_DJF_sd=readRDS("data/bologna_LST_DJF_sd.rds")
bologna_LST_SON_sd=readRDS("data/bologna_LST_SON_sd.rds")
bologna_LST_MAM_sd=readRDS("data/bologna_LST_MAM_sd.rds")
bologna_LST_JLA_sd=readRDS("data/bologna_LST_JLA_sd.rds")
...
palermo_LST_DJF_mean=readRDS("data/palermo_LST_DJF_mean.rds")
palermo_LST_SON_mean=readRDS("data/palermo_LST_SON_mean.rds")
palermo_LST_MAM_mean=readRDS("data/palermo_LST_MAM_mean.rds")
palermo_LST_JLA_mean=readRDS("data/palermo_LST_JLA_mean.rds")
palermo_LST_DJF_sd=readRDS("data/palermo_LST_DJF_sd.rds")
palermo_LST_SON_sd=readRDS("data/palermo_LST_SON_sd.rds")
palermo_LST_MAM_sd=readRDS("data/palermo_LST_MAM_sd.rds")
palermo_LST_JLA_sd=readRDS("data/palermo_LST_JLA_sd.rds")
